...
class ResponsesBulkReader extends Reader {
     ...
     * })
     */
    constructor(surveyId: string, requestOptions: RequestOptions, readableOptions: ReadableOptions = {}) {
        super({ ...requestOptions, url: `surveys/${surveyId}/responses/bulk`}, readableOptions);
    }
}
