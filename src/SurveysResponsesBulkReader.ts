...
class SurveysResponsesBulkReader extends Readable {
    ...
    private surveysReader: SurveysReader;
    ...
    constructor(requestOptions: RequestOptions, readableOptions: ReadableOptions = {}) {
        ...
        this.surveysReader = new SurveysReader(this.requestOptions, this.readableOptions);
    ...
    public initResponsesBulkReader(id: string) {
        if (this.responsesBulkReader) { throw  new Error(); }
        this.responsesBulkReader = new ResponsesBulkReader(id, this.requestOptions, this.readableOptions);
